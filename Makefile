...
.PHONY : all
all : microc.native printbig.o splitfile.o
...
splitfile : splitfile.c
	cc -o splitfile -DBUILD_TEST splitfile.c
...
TESTS = add1 arith1 arith2 arith3 fib for1 for2 func1 func2 func3	\
    ...
    while1 while2 splitfile minimap
...
TARFILES = ast.ml codegen.ml Makefile _tags microc.ml parser.mly README \
        scanner.mll semant.ml testall.sh printbig.c splitfile.c arcade-font.pbm font2c \
	$(TESTFILES:%=tests/%)
